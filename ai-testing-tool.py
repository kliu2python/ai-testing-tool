"""AI-driven cross-platform UI automation and reporting tool."""
...
if __name__ == "__main__":
    ...
    for task in tasks:
        ...
        if steps:
            for step_action in steps:
                ...
                write_to_file(
                    f"{task_folder}/step_{step}.json", next_action_with_result
                )
    ...
    generate_summary_report(reports_folder, summary)
    driver.quit()
